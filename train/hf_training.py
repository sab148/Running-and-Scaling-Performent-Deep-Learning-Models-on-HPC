...
def get_model(name: str = "gpt2"):
    ...
    #
    model = AutoModelForSequenceClassification.from_pretrained(name, use_cache=False)
...
if '__main__' == __name__:
    ...
    if 'ddp' == args.training_type:
        ...
        raise NotImplemented(f"unknown --training_type={args.training_type}")
    ...
    #
    # everything is not that simple. Some options are implemented only for
